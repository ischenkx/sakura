...
// int2int is a map-like data-structure for int64s
type int2int struct {
...
func newInt2Int(size int, fillFactor float64) *int2int {
...
func (m *int2int) shiftKeys(pos int64) int64 {
...
func (m *int2int) Size() int {
	return m.size
}

// Keys returns a channel for iterating all keys.
func (m *int2int) Keys() chan int64 {
...
func (m *int2int) Iter(f func (int64, int64)) {
	data := m.data
	var k int64
